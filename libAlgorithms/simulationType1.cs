...
namespace Simulation
{
    ...
    /// </summary>
    public class aSimulationType1 : aSimulation
    {
        public class agendaType1 : agenda
        {
            public double czas;                                  // Czas systemowy
            private int _MaxSize;
            private int _count;
            private processSym[] _tab;

            public agendaType1(aSimulationType1 alg)
            {
                this.AlgSym = alg;
                _count = 0;
                _MaxSize = 1024;
            ...
            //            _tab[idx].wzglCzas -= przesuniecieCzasu;
            //        przesuniecieCzasu = 0;
            //    }
            //}
        ...
        {
            lZdarzen[nrBadania] = new agendaType1(this);
