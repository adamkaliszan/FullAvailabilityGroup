...
namespace Simulation
{
    ...
    /// </summary>
    public class aSimulationType2 : aSimulation
    {
        public class agendaType2 : agenda
        {
            private int _MaxSize;
            private int _count;
            private processSym[] _tab;

            public agendaType2(aSimulationType2 alg)
            {
                this.AlgSym = alg;
                _count = 0;
                _MaxSize = 1024;
        ...
        public aSimulationType2(Wiazka wSymulowana)
            : base(wSymulowana, 2, wSymulowana.bazaDanych, "bezwzględny czas, statystyki na zmiennych typu double")
        {
            SkrNazwaAlg = "Sym2";
            NazwaAlg = "Symulacja typ 2";
            _symulacja = true;
        }
        ...
        {
            lZdarzen[nrBadania] = new agendaType2(this);
        ...
        {
            agendaType2 agendaSym = lZdarzen[nrBadania] as agendaType2;
