...
namespace Simulation
{
    ...
    /// </summary>
    public class aSimulationType5 : aSimulation
    {
        public class agendaTyp5 : agenda
        {
            private int _MaxSize;
            private int _count;
            private processSym[] _tab;

            public agendaTyp5(aSimulationType5 alg)
            {
                this.AlgSym = alg;
                _count = 0;
                _MaxSize = 1024;
            ...
            {
                dodawany.czas = (float)(dodawany.czas);
                dodawany.idx = _count;
                incCount();
            ...
            public void CofnijCzasy(float cofnocO)
            {
                for (int idx = 0; idx < _count; idx++)
                    _tab[idx].czas = (float)((float)(_tab[idx].czas) - cofnocO);
            }
